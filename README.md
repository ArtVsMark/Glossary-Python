...
| --- | --- | --- |
| `active` + механизм | <!--m:rules_mechanised-->95<!--/m:rules_mechanised--> | Правило действует и держится гейтом (<!--m:rules_gate-->55<!--/m:rules_gate-->), документом (<!--m:rules_document-->28<!--/m:rules_document-->) или конвейером (<!--m:rules_pipeline-->12<!--/m:rules_pipeline-->) |
| `active` + `none` | <!--m:rules_none-->21<!--/m:rules_none--> | Правило действует, но здесь ничем не держится — у каждого названа причина |
| `not-applicable` | <!--m:rules_na-->65<!--/m:rules_na--> | Предмета правила в этом проекте нет — с объяснением, почему |

**<!--m:rules_none-->21<!--/m:rules_none--> — это метрика, и она должна уменьшаться.** Потолок зафиксирован в
