...
| --- | --- | --- |
| `active` + механизм | <!--m:rules_mechanised-->98<!--/m:rules_mechanised--> | Правило действует и держится гейтом (<!--m:rules_gate-->58<!--/m:rules_gate-->), документом (<!--m:rules_document-->28<!--/m:rules_document-->) или конвейером (<!--m:rules_pipeline-->12<!--/m:rules_pipeline-->) |
| `active` + `none` | <!--m:rules_none-->19<!--/m:rules_none--> | Правило действует, но здесь ничем не держится — у каждого названа причина |
| `not-applicable` | <!--m:rules_na-->64<!--/m:rules_na--> | Предмета правила в этом проекте нет — с объяснением, почему |

**<!--m:rules_none-->19<!--/m:rules_none--> — это метрика, и она должна уменьшаться.** Потолок зафиксирован в
