...
| --- | --- | --- |
| `active` + механизм | <!--m:rules_mechanised-->71<!--/m:rules_mechanised--> | Правило действует и держится гейтом (<!--m:rules_gate-->37<!--/m:rules_gate-->), документом (<!--m:rules_document-->27<!--/m:rules_document-->) или конвейером (<!--m:rules_pipeline-->7<!--/m:rules_pipeline-->) |
